...
% - uses integral function for Nee1994 time varying example and Iwasa
...
function dy = odeSnyIntVaryFn(ts, y, xsetMx, numRV, Tsp, nLinCurr, intT, lamb)
...
lamtdiag = getNeeTimeVaryIntFn(ts, xsetMx, numRV, Tsp, nLinCurr, intT, lamb);
