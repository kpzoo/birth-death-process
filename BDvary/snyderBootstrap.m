% Function to bootstrap the Snyder filter
function [qn, tn] = snyderBootstrap(m, tspec, nData, xsetMx, numRV, rhotT, lamt, mut, nLin)

% Assumptions and modifications
% - does standard Snyder analysis with outputs for bootstrap
