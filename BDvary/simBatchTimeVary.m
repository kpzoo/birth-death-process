...
if useParadis
    ...
    % Summary plot for logistic but only relevant if bootstrap really
    if rateID == 4
        figure;
        for i = 1:numRV
            subplot(2, 2, i);
            % errorbar required distances above and below
            Mplot = [Msny(i) Mpar(i) Mpar2(i)];
            errorbar(1:3, Mplot, Mplot - [Psny(1, i) Ppar(1, i) ...
                Ppar2(1, i)], [Psny(2, i) Ppar(2, i) Ppar2(2, i)] - Mplot, 'rd');
            grid;
            h = gca;
